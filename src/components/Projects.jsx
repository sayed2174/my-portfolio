...
//     description: "its an windows application which comes with .exe and used for uninstalling or debloating the android applications from windows operating system",
//     tech: ["Python", "Java", "android", "android studio", "chaquopy", "materail3"],
//     link: "https://github.com/sayed2174/Android-Debloater-APP",
//   },
//   {
...
//     link: "https://github.com/sayed2174/Live-Wallpaper-Android-App",
//   },
//   {
...
//   },
//   {
//     title: "YT or Video Downloader",
//     description: "Youtube Video Downloader android app which uses yt-dlp python interpreted library which handled by chaquopy python interpreter",
//     tech: ["android", "android studio", "chaquopy", "material3", "Threading", "Java"],
//     link: "https://github.com/sayed2174/YT-Downloader",
//   },
//   {
...
//     link: "https://github.com/sayed2174/FormToGoogleSheetDataToWeb",
//   },
//   {
...
//     link: "https://github.com/sayed2174/Loan-Approval-Prediction-System",
//   },
//   {
...
//     link: "https://github.com/sayed2174/Customer-Churn-Prediction",
//   },
//   {
...
//     tech: ["android", "HTML", "CSS", "android studio", "Java"],
//     link: "https://github.com/sayed2174/Body-Health-Diet-Calculator",
//   },
// ];
...
export default function Projects() {
  ...
  return (
    <motion.section
      id="projects"
      className="w-full p-4 bg-gray-100 dark:bg-gray-900"
      initial={{ opacity: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {projects.map((proj, idx) => (
            <motion.div
              ...
              className={`p-5 rounded-xl shadow-md cursor-pointer 
            ...
            >
              ...
              <div className="flex flex-wrap gap-1">
                {proj.tech.map((tech, i) => (
                  <span
                    key={i}
                    className="px-2 py-1 text-xs bg-white/70 dark:bg-black/50 text-gray-900 dark:text-gray-200 
                               rounded-full"
                  >
                    {tech}
                  </span>
